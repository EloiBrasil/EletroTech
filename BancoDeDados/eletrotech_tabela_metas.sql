...
CREATE TABLE `tabela_metas` (
  ...
  `mes_meta` date DEFAULT NULL,
  `vlr_meta` decimal(10,2) DEFAULT NULL,
  `eletricista_meta` int DEFAULT NULL,
  PRIMARY KEY (`id_meta`),
  KEY `eletricista_meta` (`eletricista_meta`),
  CONSTRAINT `tabela_metas_ibfk_1` FOREIGN KEY (`eletricista_meta`) REFERENCES `tabela_eletricistas` (`id_eletri`)
